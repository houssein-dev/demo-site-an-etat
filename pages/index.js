            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center">
                <div className="bg-gray-200 h-96 rounded-lg flex items-center justify-center">
                  <Image
                    src="https://houssein-dev.github.io/demo-site-an-etat/images/presentation.jpg"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="text-center">
                <div className="bg-white h-96 rounded-lg shadow-lg flex items-center justify-center mb-4">
                  <Image
                    src="https://houssein-dev.github.io/demo-site-an-etat/images/directeur.jpg"
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-50 rounded-lg shadow hover:shadow-lg transition overflow-hidden">
                <Image
                  src="https://houssein-dev.github.io/demo-site-an-etat/images/news1.jpg"
                  alt="خبر 1"
                  width={400}
                  height={250}
              ...
              <div className="bg-gray-50 rounded-lg shadow hover:shadow-lg transition overflow-hidden">
                <Image
                  src="https://houssein-dev.github.io/demo-site-an-etat/images/news2.jpg"
                  alt="خبر 2"
                  width={400}
                  height={250}
                  className="object-cover w-full h-48"
              ...
              <div className="bg-gray-50 rounded-lg shadow hover:shadow-lg transition overflow-hidden">
                <Image
                  src="https://houssein-dev.github.io/demo-site-an-etat/images/news3.jpg"
                  alt="خبر 3"
                  width={400}
                  height={250}
                  className="object-cover w-full h-48"
